-- إزالة نظام الفروع والعودة لنظام محل واحد
-- هذا سيحذف جدول الفروع وينقل البيانات إلى جدول مخزون واحد
...
-- 10. تحديث trigger للمنتجات الجديدة
