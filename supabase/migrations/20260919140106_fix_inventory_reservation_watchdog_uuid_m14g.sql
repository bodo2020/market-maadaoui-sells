-- M14g — production UUID aggregation hotfix retained for migration-history parity.
-- The M14f repository snapshot is already corrected; re-applying the final function
-- definition keeps fresh environments and production history convergent.
