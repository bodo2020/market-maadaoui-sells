-- Reporting V2 authoritative state sync.
-- This migration mirrors the production engine after the 17:44-17:50 reporting migrations.
...
grant execute on function public.get_reporting_overview_v2(uuid,timestamptz,timestamptz) to authenticated,service_role;
