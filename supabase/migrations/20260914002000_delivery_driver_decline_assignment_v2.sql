...
begin
  ...
  if v_assignment.delivery_state <> 'assigned' then
...
revoke all on function public.decline_my_delivery_order_v1(uuid, text) from public;
revoke all on function public.decline_my_delivery_order_v1(uuid, text) from anon;
grant execute on function public.decline_my_delivery_order_v1(uuid, text) to authenticated;
grant execute on function public.decline_my_delivery_order_v1(uuid, text) to service_role;
