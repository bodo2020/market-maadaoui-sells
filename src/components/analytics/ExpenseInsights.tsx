...
import { Sparkles, Loader2, Receipt, Download } from "lucide-react";
...
const ExpenseInsights = ({ selectedPeriod }: ExpenseInsightsProps) => {
  ...
  const handleDownloadPDF = () => {
    ...
    doc.setR2L(true);
    doc.setFontSize(18);
    doc.text("تحليل المصروفات وتوصيات التوفير", 105, 20, { align: "center" });
    doc.setFontSize(10);
    ...
    doc.save(`تحليل-المصروفات-${new Date().toLocaleDateString("ar-EG")}.pdf`);
