...
import { Sparkles, Loader2, DollarSign, Download } from "lucide-react";
...
const ProfitInsights = ({ selectedPeriod }: ProfitInsightsProps) => {
  ...
  const handleDownloadPDF = () => {
    ...
    doc.setR2L(true);
    doc.setFontSize(18);
    doc.text("تحليل الأرباح والميزانية الإعلانية", 105, 20, { align: "center" });
    doc.setFontSize(10);
    ...
    doc.save(`تحليل-الأرباح-${new Date().toLocaleDateString("ar-EG")}.pdf`);
        ...
        <CardHeader>
          <CardTitle className="flex items-center justify-between">
            <span className="flex items-center gap-2">
              ...
              تحليل الأرباح والميزانية الإعلانية
            </span>
            <Button 
          ...
          {insights ? (
            ...
            <div className="text-center py-12 text-muted-foreground">
              ...
              <ul className="mt-4 space-y-2 text-sm">
                <li>• تحليل هوامش الربح</li>
                <li>• حساب صافي الربح</li>
                <li>• الميزانية المقترحة للإعلانات</li>
                <li>• توصيات لزيادة الأرباح</li>
              </ul>
            </div>
          )}
        </CardContent>
