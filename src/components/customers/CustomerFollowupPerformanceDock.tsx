      ...
      <Sheet open={open} onOpenChange={setOpen}>
        <SheetContent side="left" dir="rtl" className="w-full overflow-y-auto sm:max-w-2xl">
          <SheetHeader className="text-right">
            <SheetTitle className="flex items-center gap-2"><Target className="h-5 w-5 text-[#005931]" />نتائج متابعة العميل</SheetTitle>
            <SheetDescription>هل المتابعة رجّعت العميل للشراء؟ وكم مبيعات نتجت عنها فعليًا.</SheetDescription>
          </SheetHeader>
          <div className="mt-5"><CustomerFollowupPerformanceCard customerId={customerId} /></div>
        </SheetContent>
      </Sheet>
    </>
  );
