import {
  ...
  Calendar, CalendarCheck2, FileSpreadsheet, ArrowLeftRight, BellRing, ShieldCheck, Network, Clock3, Banknote, KeyRound, Vault, Landmark, Bot, Store, Headphones,
} from 'lucide-react';
...
export const productsNavigation: NavigationGroup = {
  ...
  items: [
    ...
    { label: 'الموردون والمشتريات', href: '/supplier-purchases', icon: Truck },
...
export const customersNavigation: NavigationGroup = {
  ...
  items: [
    { label: 'خدمة العملاء', href: '/customer-service', icon: Headphones },
...
export const marketplaceNavigation: NavigationGroup = {
  ...
  items: [
    ...
    { label: 'موافقات تشغيل Franchise', href: '/franchise-operations-approvals', icon: ShieldCheck, adminOnly: true },
  ],
};
