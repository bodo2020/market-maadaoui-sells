...
export default function CompanyDetails() {
  ...
  return <MainLayout>
      <div className="container mx-auto p-6">
            ...
            <Card>
              ...
              <CardContent>
                <div className="flex gap-2 mb-6">
                  <Input placeholder="البحث عن منتج..." value={searchQuery} onChange={e => setSearchQuery(e.target.value)} className="max-w-sm" />
        ...
        <AddProductDialog isOpen={isAddProductDialogOpen} onClose={() => setIsAddProductDialogOpen(false)} onProductAdded={() => loadCompanyDetails(company.id)} companyId={company.id} />
      </div>
    </MainLayout>;
}