...
import { updateProductCollection, fetchProductCollections } from "@/services/supabase/productCollectionsService";
import { Product } from "@/types";
import { Plus, X } from "lucide-react";
import { siteConfig } from "@/config/site";

export default function EditProductCollection() {
  ...
  const loadCollection = async () => {
    try {
      ...
      if (currentCollection) {
        ...
        setSelectedProducts(currentCollection.products || []);
      } else {
      ...
      toast.error("حدث خطأ أثناء تحميل المجموعة");
    }
  };
  ...
  const handleUpdateCollection = async () => {
    try {
      ...
      await updateProductCollection(id!, {
          ...
          <CardContent>
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <h3 className="font-semibold">المنتجات في المجموعة</h3>
