...
import NativePosProvisionGate from '@/components/POS/NativePosProvisionGate';
...
import FinanceWalletOperationsV4 from '@/pages/FinanceWalletOperationsV4';
...
import FranchiseOnboardingPage from '@/pages/FranchiseOnboardingPage';
...
const CashierPOS = () => (
  <NativePosProvisionGate><PosShiftGatePro><PosRuntimeGuard><PosWorkspaceRecoveryGate><><POSPro /><POSCustomerLoyaltyBridge /><PosRecentSales /><DeliveryCashHandoverDock /></></PosWorkspaceRecoveryGate></PosRuntimeGuard></PosShiftGatePro></NativePosProvisionGate>
);
...
export default function AppRoutes() {
  return (
    <Routes>
      ...
      <Route path='/finance/wallet-operations' element={<ProtectedRoute><FinanceWalletOperationsV4 /></ProtectedRoute>} />
      ...
      <Route path='/franchise/new' element={<ProtectedRoute allowedRoles={marketplaceRoles}><FranchiseOnboardingPage /></ProtectedRoute>} />
      <Route path='/franchise/:merchantId' element={<ProtectedRoute allowedRoles={marketplaceRoles}><FranchiseDetailsPage /></ProtectedRoute>} />
      <Route path='/franchise-operations-approvals' element={<ProtectedRoute allowedRoles={marketplaceRoles}><FranchiseOperationApprovalsPage /></ProtectedRoute>} />
